...
### ASSET:
The home row shares a lot of characteristics. The creator of ASSET likely saw many of the same opportunities. But I think the creator went with the home row concept and moved keys to the Qwerty G and H positions. ASERT avoids these extra changes and actually has better placement of all the other keys on the top row, bottom row, center columns. The D, J, U, K, G, Y are in better spots. This has fewer letters change fingers, no extra unnecessary changes, maintains more muscle memory, and is easier to learn. IMO a big win over ASSET. 
